package com.clinica.pacientes.core.openapi;
...
import com.clinica.pacientes.controller.exceptionhandler.Problem;
	...
	public OpenAPI openAPI() {
		return new OpenAPI()
				.info(new Info()
						...
						.version("v1")
						.description("Microsservice responsavel pelo armazenamento e consultas sobre os pacientes"))
