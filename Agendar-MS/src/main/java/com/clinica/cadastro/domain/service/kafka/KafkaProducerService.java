...
public class KafkaProducerService {
	...
	public void sendMessage(String topic, Object value, String key) {
		
		final ProducerRecord<String, Object> data = createRecord(topic, key, value);
	...
	private ProducerRecord<String, Object> createRecord(String topic, String key, Object value) {
		return new ProducerRecord<String, Object>(topic, key, value);
	}
}
