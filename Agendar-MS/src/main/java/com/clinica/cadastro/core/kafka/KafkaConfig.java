...
public class KafkaConfig {
	...
	@Bean
	public ProducerFactory<String, MedicalAppointmentDtoFinancial> producerAppointment() {
	...
	@Bean
	public KafkaTemplate<String, MedicalAppointmentDtoFinancial> kafkaTemplate(){
